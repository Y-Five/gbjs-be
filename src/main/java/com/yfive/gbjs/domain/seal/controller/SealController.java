...
public interface SealController {
  ...
  ResponseEntity<ApiResponse<UserSealResponse.NearbySealListDTO>> getNearbySeals(
      @Parameter(hidden = true) Authentication authentication,
      @RequestParam(defaultValue = "36.583333") @Parameter(description = "현재 위치 위도", required = true, example = "36.583333")
      Double latitude,
      @RequestParam(defaultValue = "128.516667") @Parameter(description = "현재 위치 경도", required = true, example = "128.516667")
      Double longitude);
